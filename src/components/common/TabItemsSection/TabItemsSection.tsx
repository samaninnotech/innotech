...
import { ContentHeading, ContentText, Header, TabContentContainer, TabContentWrapper, TabsContainer, TabsHeader } from './TabItemsSection.styled';
...
type ContentItem = {
  ...
  const TabItemsSection: React.FC<TabItemsSectionProps> = ({header,tabItems}) => {
